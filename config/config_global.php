...
$_config['db']['1']['dbuser'] = 'code4god';
$_config['db']['1']['dbpw'] = 'Nwpu1234';
...
// --------------------------  CONFIG COOKIE  --------------------------- //
$_config['cookie']['cookiepre'] = 'Rkkz_';
$_config['cookie']['cookiedomain'] = '';
$_config['cookie']['cookiepath'] = '/';

// -------------------------  CONFIG SECURITY  -------------------------- //
$_config['security']['authkey'] = 'a63eb4XXY1Y52Cmm';
